    ...
    steps:
      ...
      - name: 👤 TẠO TÀI KHOẢN PREMIUM
        run: |
          ...
          # Tạo user mới với đầy đủ quyền - ĐÃ SỬA LỖI
          try {
              # SỬA LỖI: Tạo user không dùng PasswordNeverExpires parameter
              ...
              # Thiết lập mật khẩu không bao giờ hết hạn
